    ...
    return BlocBuilder(
      ...
      builder: (context, state) {
        return BlocListener(
          ...
          child: Form(
            key: context.read<InputValueCreateCubit>().formKey,
            child: Scaffold(
                appBar: AppBar(
                  leading: IconButton(
                      onPressed: () {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: SingleChildScrollView(
                        ...
                        child: Padding(
                          padding:
                              EdgeInsets.symmetric(horizontal: AppSizeW.s22),
                          child: Column(
                                                                ...
                                                                child:
                                                                    IconButton(
                                                                        onPressed:
                                                                          ...
                                                                          context
                                                                              .read<InputValueCreateCubit>()
                                                                              .setFromBarcode(!context.read<InputValueCreateCubit>().fromBarcode);
                                                                        },
                                                                        icon: const Icon(
