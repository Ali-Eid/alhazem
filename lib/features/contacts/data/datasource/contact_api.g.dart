...
class _ContactsServiceClient implements ContactsServiceClient {
  ...
  Future<HttpResponse<ResponseModel<ContactModel>>> createTraveler(
    ...
    final _data = input;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<ResponseModel<ContactModel>>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ResponseModel<ContactModel>.fromJson(
      _result.data!,
  ...
  @override
  Future<HttpResponse<ResponseModel<List<ContactDetailsModel>>>> getContactById(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<ResponseModel<List<ContactDetailsModel>>>>(
            Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    ...
    final value = ResponseModel<List<ContactDetailsModel>>.fromJson(
      _result.data!,
      (json) => json is List<dynamic>
          ? json
              .map<ContactDetailsModel>((i) =>
                  ContactDetailsModel.fromJson(i as Map<String, dynamic>))
              .toList()
          : List.empty(),
    );
    final httpResponse = HttpResponse(value, _result);
  ...
  @override
  Future<HttpResponse<ResponseModel<List<StaticModel>>>>
      getAttachmentsType() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<ResponseModel<List<StaticModel>>>> getOffices() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<ResponseModel<List<StaticModel>>>> getCountries() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
